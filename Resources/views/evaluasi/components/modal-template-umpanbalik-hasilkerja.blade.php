<div class="modal fade" id="template-umpanbalik-hasilkerja-{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Template Umpan Balik Hasil Kerja</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <select class="custom-select template-select" name="">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary hasil-kerja" data-dismiss="modal">Terapkan ke semua</button>
