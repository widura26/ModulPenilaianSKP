...
class MenuPenilaianTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $menu =  Menu::create([
            ...
            'can' => serialize(['direktur','terdaftar', 'operator', 'admin', 'pegawai', 'kajur', 'wadir1', 'wadir2', 'wadir3', 'dosen']),
            'icon' => 'far fa-circle',
            'urut' => 1,
            'parent_id' => 0,
            'active' => '',
        ...
        Menu::create([
            ...
            'url' => 'skp/rencana',
            // 'can' => serialize(['pimpinan', 'pejabat', 'sekretaris', 'kepegawaian', 'dosen']),
            'can' => serialize(['direktur','terdaftar', 'operator', 'pegawai', 'kajur', 'wadir1', 'wadir2', 'wadir3', 'dosen']),
            'icon' => 'far fa-circle',
            'urut' => 1,
            'parent_id' => $menu->id,
        ...
        Menu::create([
            ...
            'can' => serialize(['direktur','terdaftar', 'kajur', 'wadir1', 'wadir2', 'wadir3', 'direktur', 'kaprodi', 'kaunit']),
            'icon' => 'far fa-circle',
            'urut' => 1,
            'parent_id' => $menu->id,
        ...
        Menu::create([
            ...
            'url' => 'skp/persetujuan',
            // 'can' => serialize(['pimpinan', 'pejabat', 'sekretaris', 'kepegawaian', 'dosen']),
            'can' => serialize(['direktur','terdaftar', 'kajur', 'wadir1', 'wadir2', 'wadir3']),
            'icon' => 'far fa-circle',
            'urut' => 1,
            'parent_id' => $menu->id,
